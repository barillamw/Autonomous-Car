...
void Line_Detect(void){
  ...
  HEXtoBCD(V_Detect_L);
  strcpy(LeftVal,"LFT:       ");
  LeftVal[CHAR6] = bcd_char[CHAR0];
  LeftVal[CHAR7] = bcd_char[CHAR1];
  LeftVal[CHAR8] = bcd_char[CHAR2];
  LeftVal[CHAR9] = bcd_char[CHAR3];
  strcpy(display_line[THIRD_LINE],LeftVal);
  
  HEXtoBCD(V_Detect_R);
  strcpy(RightVal,"RHT:       ");
  RightVal[CHAR6] = bcd_char[CHAR0];
  RightVal[CHAR7] = bcd_char[CHAR1];
  RightVal[CHAR8] = bcd_char[CHAR2];
  RightVal[CHAR9] = bcd_char[CHAR3];
