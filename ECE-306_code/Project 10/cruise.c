...
void wheels(int SpeedR, int SpeedL){
  if(SpeedR > RESET){
    RIGHT_REVERSE_SPEED = WHEEL_OFF;
    RIGHT_FORWARD_SPEED = SpeedR * HUNDREDS;
  }
  else if (SpeedR < RESET){
    RIGHT_FORWARD_SPEED = WHEEL_OFF;
    RIGHT_REVERSE_SPEED = SpeedR * -HUNDREDS;
  }
  else {
    RIGHT_FORWARD_SPEED = WHEEL_OFF;
    RIGHT_REVERSE_SPEED = WHEEL_OFF;
   ...
   if(SpeedL > RESET){
    ...
    LEFT_FORWARD_SPEED = SpeedL * HUNDREDS;
  }
  else if (SpeedL < RESET){
    LEFT_FORWARD_SPEED = WHEEL_OFF;
    LEFT_REVERSE_SPEED = SpeedL * -HUNDREDS;
  }
  else {
    LEFT_FORWARD_SPEED = WHEEL_OFF;
    LEFT_REVERSE_SPEED = WHEEL_OFF;
